<template>
    <div class="card ">
        <div>
            <img class="object-cover w-full" :src=service.image style="height: 250px;">
        </div>
        <div class="card-title backdrop-blur-sm">
            <div class="my-4 pl-4 pr-2 border-r-1 border-white ">
                <svg fill="#ffffff" width="32px" height="32px" viewBox="0 0 56 56" id="Layer_1" version="1.1"
            ...
            <p class="text-white text-lg">{{ service.title }}</p>
        </div>
        <div class="p-6">
            <div class="mb-4 text-sm text-gray-700 ">{{ service.text }}</div>
            <button class="font-semibold text-sm border-b-2 border-black"> <a :href=service.link>READ MORE</a> </button>
        </div>
